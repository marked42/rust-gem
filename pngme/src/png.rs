...
impl Png {
    ...
    /// first byte of signature is a non ascii char to prevent plain text file from
    /// be recognized as png file
    pub const SIGNATURE: [u8; Self::SIGNATURE_LENGTH] =
    ...
    pub fn header(&self) -> &[u8; Self::SIGNATURE_LENGTH] {
        &Self::SIGNATURE
    }
